...
const url = "mongodb+srv://willison:kWOTjli7VZfkImK9@cluster0.wbcsunn.mongodb.net";
...
async function main() {
  ...
  app.listen(process.env.PORT || 3000, function () { //acessar a variavel com a porta disponibilizada pelo heroku process.env.PORT
